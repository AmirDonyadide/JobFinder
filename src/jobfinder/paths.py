...
"""Google authorized-user token cache file used for Sheets and Drive."""

GOOGLE_DRIVE_TOKEN_FILE = GOOGLE_TOKEN_FILE
"""Backward-compatible alias for the shared Google OAuth token file."""
