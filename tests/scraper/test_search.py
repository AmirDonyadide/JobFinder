...
def test_run_actor_uses_async_api_and_fetches_dataset(monkeypatch):
    ...
    monkeypatch.setattr("jobfinder.providers.apify_client.requests.post", fake_post)
    monkeypatch.setattr("jobfinder.providers.apify_client.requests.get", fake_get)
